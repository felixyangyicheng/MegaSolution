...
namespace MegaSolution.Migrations
{
    ...
    [Migration("20210524143827_ArtistProfileLineOffer")]
    partial class ArtistProfileLineOffer
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MegaSolution.Data.ArtistProfile", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("MegaSolution.Data.LineOffer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MegaSolution.Data.ArtistProfile", b =>
                {
                    b.HasOne("MegaSolution.Data.ApplicationUser", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("MegaSolution.Data.LineOffer", b =>
                {
                    b.HasOne("MegaSolution.Data.ArtistProfile", null)
                        .WithMany("LineOffers")
                        .HasForeignKey("ArtistProfileId");

                    b.HasOne("MegaSolution.Data.Offer", "Offer")
                        .WithMany()
